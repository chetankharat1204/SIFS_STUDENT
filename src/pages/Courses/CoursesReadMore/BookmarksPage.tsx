...
import type { Bookmark } from "../../../types/courseTypes";
...
export default function BookmarksPage() {
        ...
        const transformedBookmarks: Bookmark[] = Array.isArray(bookmarksData)
          ? bookmarksData.map((item: any) => {
            ...
            return {
              ...
              course_id: item.studentCourseID || item.student_course_id || item.course?.id || item.course_id || item.courseID,
              course_name: getName(item.course) || getName(item.course_name) || getName(item.course_title) || "NA",
  ...
  const handleView = (bookmark: Bookmark) => {
    ...
    navigate(`/courses/${bookmark.course_id}?subject=${bookmark.subject_id}&los=${bookmark.los_id}&tab=courses`, {
      state: {
